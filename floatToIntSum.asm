...
#####################################################################
		.data
prompt:		.asciiz	"\n   Please Input a value for N (N>=1) =  "
floatValue:     .asciiz "\n The float value entered: "
intValue:	.asciiz "\n The truncated integer used: "
floatOneConst:	.float	0.9999999
...
printFloatInt:
		#Prints the float value and integer value
		li $v0, 4
		la $a0, floatValue
		syscall
...
loop:		
		add	$s3, $s3, $t5		# sum of integers in register $s2
